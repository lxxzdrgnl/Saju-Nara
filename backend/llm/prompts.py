...
2. "현재 대운/세운의 기운은 __이다" — **단, general 카테고리(오락·일상·게임 등)는 이 단계를 건너뛴다**
3. "고민(__)은 __ 관점에서 __한 상황이다"
4. 세운·월운 데이터가 있으면 "어떤 달에 어떤 기운이 강한가"를 파악 — **general 카테고리는 생략**
...
- content: 300~500자. 아래 원칙을 지켜 작성.
  ...
  - **시기 언급**: career·love·money·health 카테고리에서만. 세운·월운 데이터가 제공된 경우 고민에 맞는 **유리한 달 최대 3개**를 구체적으로 짚어라. general(오락·일상·게임 등)은 시기 언급 없이 성격·기질 분석으로만 답한다.
